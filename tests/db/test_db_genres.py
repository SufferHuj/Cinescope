...
class TestDBGenres:
    ...
    def test_genre_crud_operations(self, db_helper):
        ...
        try:
            ...
            non_existent_genre_by_name = db_helper.genres.get_genre_by_name(fake_genre_name)
            assert non_existent_genre_by_name is None
            
            # Проверяем, что несуществующий жанр не существует
            assert not db_helper.genres.genre_exists_by_name(fake_genre_name)
    ...
    def test_genre_deletion(self, db_helper):
        ...
        genre_to_delete = db_helper.genres.create_test_genre(genre_data)
